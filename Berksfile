...
group :integration do
  cookbook 'kitchen-test-helper', '~> 1.0.0'
  cookbook 'memcached-helper', '~> 1.0', path: 'test/helpers/memcached-helper'
  ...
  cookbook 'libpg-helper', '~> 1.0.5', path: 'test/helpers/libpg-helper'
end
